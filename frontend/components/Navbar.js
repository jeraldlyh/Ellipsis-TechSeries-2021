...
export default function Navbar() {
  ...
  return (
    <div className="top-0 sticky font-semibold flex bg-white items-center justify-between px-10 pt-1 pb-3">
      ...
      <div className="flex items-center justify-between w-56">
        ...
        <div className="tracking-wider text-xs cursor-pointer" onClick={() => router.push("/")}>Login</div>
