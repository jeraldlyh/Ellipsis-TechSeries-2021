        ...
        {/* <div className="tracking-wider text-xs cursor-pointer" onClick={() => router.push("/")}>Help</div> */}
        {
          session
            ...
            <div className="w-80 flex justify-between items-center">
              <div className="tracking-wider text-xs cursor-pointer flex items-center" onClick={() => router.push("/profile")}>
                <img src="/profile/icon.png" className="w-6 h-6 rounded-full mr-3" />
                Name
              </div>
              <div className="tracking-wider text-xs cursor-pointer flex items-center" onClick={() => router.push("/listings")}>
                My Listings
              </div>
              <div className="py-2 px-6 tracking-wider bg-black rounded-md text-white text-xs cursor-pointer hover:bg-gray-700" onClick={logout}>Logout</div>
            </div>
            :
