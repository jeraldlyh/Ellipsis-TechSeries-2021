...
export default function ListingItem(props) {
    ...
    return (
        <div className={isCardView ? visible : hidden}>
            <img className="pb-5" src={props.image} width="240" height="330" onClick={() => { router.push({ pathname: "/listing/" + `${props.id}` }) }} />
            ...
            <div className="flex flex-col items-center px-20" onClick={() => { router.push({ pathname: "/listing/" + `${props.id}` }) }}>
